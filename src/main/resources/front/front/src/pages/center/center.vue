    ...
    <el-tabs tab-position="left" :style='{"background":"none"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="150px">
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="学生学号" prop="xueshengxuehao">
            <el-input v-model="sessionForm.xueshengxuehao" placeholder="学生学号" readonly></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="学生姓名" prop="xueshengxingming">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="头像">
            <el-upload
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="学生电话" prop="xueshengdianhua">
            <el-input v-model="sessionForm.xueshengdianhua" placeholder="学生电话" ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="专业" prop="zhuanye">
  ...
  export default {
    ...
    created() {
      if ('xuesheng' == this.userTableName) {
        this.$set(this.sessionForm, 'xueshengxuehao', null);
      }
      if ('xuesheng' == this.userTableName) {
      ...
      if ('xuesheng' == this.userTableName) {
        this.$set(this.sessionForm, 'xueshengdianhua', null);
      }
      if ('xuesheng' == this.userTableName) {
      ...
      if ('xuesheng' == this.userTableName) {
        this.$set(this.rules, 'xueshengxuehao', [{ required: true, message: '请输入学生学号', trigger: 'blur' }]);
      }
      if ('xuesheng' == this.userTableName) {
      ...
      if ('xuesheng' == this.userTableName) {
        this.$set(this.rules, 'xueshengxingming', [{ required: true, message: '请输入学生姓名', trigger: 'blur' }]);
			...
			if ('xuesheng' == this.userTableName) {
        this.$set(this.rules, 'xueshengdianhua', [{ required: false, validator: this.$validate.isMobile, trigger: 'blur' }]);
      }
