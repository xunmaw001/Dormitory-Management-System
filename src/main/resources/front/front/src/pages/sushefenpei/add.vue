...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"10px auto","position":"relative","background":"none","display":"block"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0","background":"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(178,213,232,1) 100%)"}' label="学生学号" prop="xueshengxuehao">
            <el-select  @change="xueshengxuehaoChange" v-model="ruleForm.xueshengxuehao" placeholder="请选择学生学号">
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0","background":"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(178,213,232,1) 100%)"}' label="床位号" prop="chuangweihao">
            <el-input v-model="ruleForm.chuangweihao" 
                placeholder="床位号" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0","background":"linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(178,213,232,1) 100%)"}' label="分配日期" prop="fenpeiriqi" >
              <el-date-picker
  ...
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/xuesheng/xueshengxuehao', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.xueshengxuehaoOptions = res.data.data;
          }
        });
      },
      // 下二随
      xueshengxuehaoChange () {
        this.$http.get('follow/xuesheng/xueshengxuehao?columnValue=' + this.ruleForm.xueshengxuehao, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
